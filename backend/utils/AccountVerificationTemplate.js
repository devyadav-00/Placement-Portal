export const Account_Verification_Success_Template = (doc) => `
  <html>
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; background-color: #f9f9f9; margin: 0; padding: 20px;">
      <div style="max-width: 600px; margin: 20px auto; padding: 20px; background-color: #fff; border: 1px solid #ccc; border-radius: 10px;">
        <h2 style="text-align: center; color: #4CAF50;">Account Verified Successfully!</h2>
        <p>Dear <strong>${doc.firstname}</strong>,</p>
        <p>We are thrilled to inform you that your account has been successfully verified! You can now access all our features and resources.</p>
